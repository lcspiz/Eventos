...
<form action="{{route('serv2.update',['id'=> $serv2->codigo])}}" method="post">
	<div class="container">
	...
	<div class="form-inline">
		...
		<input type="text" class="form-control" maxlength="10" size="10" name="codigo" value="{{$serv2->codigo}}">
		<label for="nome">Descrição:</label>
		<input type="text" name="descricao" class="form-control" value="{{$serv2->descricao}}">
